...
| 0.3 | Microsoft Entra External ID adapter (`VisuAuth.EntraExternal` + `VisuAuth.EntraExternal.Web`), cursor-based pagination, DB-backed adapter-config UI. (Shipped under the `0.2.0` tag together with v0.2.) | ✅ Shipped |
