...
public sealed class EntraUserStoreTests
{
    ...
    {
        // Now that ResetTwoFactor is implemented (deletes auth methods via
        // Graph), it validates the id up front like the other store
        // methods — blank id never reaches Graph.
        var sut = BuildStore();
